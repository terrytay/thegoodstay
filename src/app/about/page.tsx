...
export const metadata: Metadata = {
  ...
  description: 'Learn about our experienced team, our philosophy of care, and why we\'re passionate about providing the best possible experience for your dog.',
  keywords: [
    'about dog boarding',
    'pet care experience',
  ...
  openGraph: {
    title: 'About The Good Stay - Professional Dog Boarding',
    description: 'Learn about our experienced team and our philosophy of care for your beloved pets.',
          ...
          <section key={index} className={`py-24 ${index % 2 === 0 ? 'bg-white' : 'bg-stone-50'}`}>
            <div className="max-w-7xl mx-auto px-8 lg:px-12">
              <div className={`grid lg:grid-cols-2 gap-16 lg:gap-24 items-center ${
                section.layout === 'image-left' ? '' : 'lg:grid-flow-col-dense'
              }`}>
                <div className={section.layout === 'image-left' ? 'lg:order-2' : 'lg:order-1'}>
        ...
        <section className="py-24 bg-amber-50">
          <div className="max-w-4xl mx-auto px-8 lg:px-12 text-center">
            ...
            <p className="font-lora text-lg text-stone-700 mb-12">
              Schedule your complimentary assessment visit and see why families choose The Good Stay
            </p>
            <a
