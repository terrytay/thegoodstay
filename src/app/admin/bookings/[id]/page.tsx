...
export default function BookingDetailPage() {
  ...
  const updateBookingStatus = async (
    newStatus: string,
    field: "status" | "booking_status" = "status"
  ) => {
    if (!booking) return;
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      {(booking.dog_first_name || booking.dog_last_name) && (
                        <p className="text-sm text-neutral-500">
                          Full name: {booking.dog_first_name}{" "}
                          {booking.dog_last_name}
                        </p>
                      )}
                    </div>
                    <div className="space-y-1 text-sm">
                      ...
                      <p>
                        ...
                        {booking.dog_gender_neuter || "Not specified"}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center space-x-2">
                        ...
                        <span>
                          {booking.owner_email || "No email provided"}
                        </span>
                      </div>
                      <div className="flex items-center space-x-2">
                ...
                <div className="bg-neutral-50 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2 text-sm">
                      ...
                      <span>
                        {formatSingaporeDateForDisplay(booking.preferred_date)}
                      </span>
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h4 className="font-medium text-neutral-900 border-b border-neutral-200 pb-2">
                    Health Information
                  </h4>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`px-2 py-1 rounded text-sm ${
                          (booking.email_send_attempts || 0) === 0
                            ? "bg-neutral-100 text-neutral-600"
                            : (booking.email_send_attempts || 0) === 1
                            ? "bg-green-100 text-green-600"
                            : (booking.email_send_attempts || 0) <= 3
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-600">
                {formatSingaporeDateForDisplay(booking.created_at)} • Initial
          ...
          {booking.terms_accepted_at && (
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">
                  {formatSingaporeDateForDisplay(booking.terms_accepted_at)} •
          ...
          {booking.updated_at && booking.updated_at !== booking.created_at && (
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">
                  {formatSingaporeDateForDisplay(booking.updated_at)} • Booking
