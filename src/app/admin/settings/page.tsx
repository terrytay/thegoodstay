          ...
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                      ...
                      <input
                        type="time"
                        value={
                          businessSettings.bookingSettings.startTime || "09:00"
                        }
                        onChange={(e) =>
                          setBusinessSettings({
                            ...businessSettings,
                      ...
                      />
                      <p className="text-xs text-neutral-500 mt-1">
                        Earliest time customers can book visits
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        type="time"
                        value={
                          businessSettings.bookingSettings.endTime || "17:00"
                        }
                        onChange={(e) =>
                          setBusinessSettings({
                            ...businessSettings,
                      ...
                      />
                      <p className="text-xs text-neutral-500 mt-1">
                        Latest time customers can book visits
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        max="365"
                        value={
                          businessSettings.bookingSettings.advanceBookingDays
                        }
                        onChange={(e) =>
                          setBusinessSettings({
                            ...businessSettings,
                    ...
                    <div>
                      ...
                      <input
                        ...
                        step="15"
                        value={
                          businessSettings.bookingSettings.assessmentDuration
                        }
                        onChange={(e) =>
                          setBusinessSettings({
                            ...businessSettings,
                    ...
                    <div>
                      ...
                      <select
                        value={
                          businessSettings.bookingSettings.timeInterval || 60
                        }
                        onChange={(e) =>
                          setBusinessSettings({
                            ...businessSettings,
                    ...
                    <div>
                      ...
                      <select
                        value={
                          businessSettings.bookingSettings.minAdvanceHours || 3
                        }
                        onChange={(e) =>
                          setBusinessSettings({
                            ...businessSettings,
            ...
            {activeTab === "notifications" && (
              <div>
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    {Object.entries(businessSettings.notifications).map(
                      ([key, value]) => (
                        <div
                          key={key}
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-amber-200 bg-amber-50 rounded-lg p-4">
                    ...
                    <p className="text-sm text-amber-800 mb-4">
                      Your data is automatically backed up daily. All
